# ml-5.py
# for complete/ incomplete/ borderline 3.4-3.75
#  with new border up and down logic
import peek
# import cv2
import math
import json
...
TRAIN_N = 18773 # 10075-complete 18773-incomplete
VALID_N = 40
TEST_N = 100
...
TRAIN_PATH = "../processed_dataset/cmp/incomplete/"
...
def getThetas():
	...
	if len(img_paths) < TRAIN_N:
		# print("img_paths != TRAIN_N :" + str(len(img_paths)))
		# exit(0)
