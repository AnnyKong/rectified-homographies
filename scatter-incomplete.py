...
FILENAME_ROTATION = 'json/incomplete/rotation_thetas_r2_18773.json'
FILENAME_PROJECTIVE = 'json/incomplete/proj_components_r2_18773.json'

WRITE_FILENAME = 'scatter-incomplete.png'
SHOW_TABLE = True
SHOW_HIST = True
