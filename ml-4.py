...
# TYPE = "border" # type = bad/good/border
# USE_TYPE = False
...
def getThetas():
	...
	write_file_r2 = 'json/rotation_thetas_r2_' + TRAIN_N + '.json'
	with open(write_file_r2, 'w') as outfile:
		json.dump(rotation_thetas_r2, outfile)

	write_file_r1 = 'json/rotation_thetas_r1_' + TRAIN_N + '.json'
...
def getProjComponents():		
	...
	write_file_r2 = 'json/proj_components_r2_' + TRAIN_N + '.json'
	with open(write_file_r2, 'w') as outfile:
		json.dump(proj_components_r2, outfile)

	write_file_r1 = 'json/proj_components_r1_' + TRAIN_N + '.json'
	with open(write_file_r1, 'w') as outfile:
