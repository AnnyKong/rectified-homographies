...
FILENAME_ROTATION = 'json/complete/rotation_thetas_r2_10075.json'
FILENAME_PROJECTIVE = 'json/complete/proj_components_r2_10075.json'

WRITE_FILENAME = 'scatter-complete.png'
SHOW_TABLE = True
SHOW_HIST = True
